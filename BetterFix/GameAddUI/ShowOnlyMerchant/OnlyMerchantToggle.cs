...
namespace BetterFix
{
    ...
    public class OnlyMerchantToggle : UnityUIKit.GameObjects.Toggle
	{
		...
		public override Image Res_Image
		{
			get
			{
				return OnlyMerchantToggle._BackgroundImage;
			}
		}
		...
		public virtual PointerEnter Res_PointerEnter
		{
			get
			{
				return OnlyMerchantToggle._pointerEnter;
			}
		}
		...
		public virtual PointerClick Res_PointerClick
		{
			get
			{
				return OnlyMerchantToggle._pointerClick;
			}
		}
		...
		public override ColorBlock Res_Colors
		{
			get
			{
				return OnlyMerchantToggle._colors;
			}
		}

		static OnlyMerchantToggle()
		{
			Transform getAllResourceIcon = Resources.Load<GameObject>("prefabs/ui/views/ui_villagemanage").transform.Find("MainWindow/BootyPanel/TotalResource/Food/GetButton");
			OnlyMerchantToggle._BackgroundImage = getAllResourceIcon.GetComponent<UnityEngine.UI.Image>();
			//ResLoader.Load<Sprite>("Graphics/HomeMap/GetAllResource", delegate (Sprite sp) { OnlyMerchantToggle._BackgroundImage.sprite = sp; }, false, null);
			...
			OnlyMerchantToggle._pointerEnter = fullScreenToggle.GetComponent<PointerEnter>();
			OnlyMerchantToggle._pointerClick = fullScreenToggle.GetComponent<PointerClick>();
			OnlyMerchantToggle._colors = new ColorBlock
			{
		...
		public override void Create(bool active = true)
		{
			...
			labelChildImage.color = Color.white;
			...
			base.Get<Image>().color = Color.white;
			...
			//新加入的，用于固定按钮大小
			this.RectTransform.sizeDelta = new Vector2(40f, 40f);
